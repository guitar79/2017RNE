...
\include{poster3/preamble} % Insert the commands.tex file which contains the majority of the structure behind the template
...
%----------------------------------------------------------------------------------------
%
{\sf\bf AirKorea 자료 분석 \\ Research Title} % Poster title
{\vspace{1em} 김병현, 김재홍, 박준호, 윤산울\\ % Author names
{\smaller j.smith@uni.edu, j.smith2@uni.edu, j.smith3@uni.edu}} % Author email addresses
{\includegraphics[scale=0.15]{logo1}} % University/lab logo
...
\include{poster3/introduction} % Introduction
}
%----------------------------------------------------------------------------------------
